...
<ul class="nav" id="main-menu">
    ...
    <li>
        <a class="active-menu" href="/comite/login"><i class="fa fa-users fa-3x"></i>Cómite Curricular</a>
    </li>            
    <li>
            ...
            <div class="row">
                <div class="col-md-10 col-md-offset-1">
                    <div class="panel panel-primary">
                        <div class="panel-heading title-caja">Miembro del Comite Curricular</div>
                        <div class="panel-body" style="padding: 30px;">
                            ...
                            <form class="form-horizontal" role="form" method="POST" action="/comite/login">
